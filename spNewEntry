USE [Sample1]
GO
/****** Object:  StoredProcedure [dbo].[spNewEntry]    Script Date: 4/19/2017 2:08:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[spNewEntry] --360.4,14.296,2.16
  @Miles DECIMAL(5,2),
  @Gallons DECIMAL(5,3),
  @Price DECIMAL(3,2)
  AS
  BEGIN
	...
	VALUES(@cnt,@Miles,@Gallons,(@Miles / @Gallons),@Price,getdate(),DATEDIFF(DAY,@StartDate,getdate()))
